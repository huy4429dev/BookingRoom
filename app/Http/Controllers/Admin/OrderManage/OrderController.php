...
namespace App\Http\Controllers\Admin\OrderManage;
...
class OrderController extends Controller
{
    ...
    {
        $data = Order::select(DB::raw('count(id) as `data`'), DB::raw('sum(total) as `tongtien`'), DB::raw("CONCAT_WS('-',MONTH(created_at),YEAR(created_at)) as monthyear"))
