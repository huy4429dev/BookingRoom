    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <table class="table mb-5 show-customer">
                ...
                <tbody>
                    @php
                        $i = 1;
                    @endphp
                    @foreach($post->roomguest as  $customer)
                    <tr>
                        <th scope="row">{{$i}}</th>
            ...
            <div class="panel panel-default">
                <div class="panel-heading mb-5">Thông tin bắt buộc*</div>
                <div class="panel-body">
                    ...
                    <form action="{{ route ('user.post.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="txttitle" value="{{$post->title}}">
                        </div>
                        <div class="form-group mt-4">
                            ...
                            <p class="mt-4"><i class="far fa-bell"></i> Nếu địa chỉ hiển thị bên bản đồ không đúng bạn có thể điều chỉnh bằng cách kéo điểm màu xanh trên bản đồ tới vị trí chính xác.</p>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="txtprice" class="form-control" placeholder="750000" value="{{$post->price}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="usr">Diện tích( m<sup>2</sup> ):</label>
                                    <input type="number" name="txtarea" class="form-control" placeholder="16" value="{{$post->area}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker pull-right" data-live-search="true" name="iddistrict">
                                        ...
                                        @if($quan->district_id === $quan->district_id)
                                        <option data-tokens="{{$quan->slug}}" value="{{ $quan->id }}" selected>{{ $quan->name }}</option>
                                        @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtphone" class="form-control" placeholder="0888.88888" value="{{$post->phone}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="txtdescription" style=" resize: none;">{{$post->description}}</textarea>
                        </div>
        ...
        <div class="col-md-4">
            <div class="contactpanel">
                <div class="row mb-5 mt-4">
                    <div class="col-md-4 text-center">
                        <img src="{{url(Auth::user()->avatar)}}" class="img-circle" alt="Cinque Terre" width="100" height="100">
                    </div>
                    <div class="col-md-8">
            ...
            <div class="gap"></div>
            <img src="{{url('images/banner.jpg')}}" width="100%">
        </div>
    </div>
</div>
@endsection
...
@section('css')
<link rel="stylesheet" href="{{url('assets/toast/toastr.min.css')}}">
<link rel="stylesheet" href="{{url('assets/css/selectize.default.css')}}">
<style>
    .form-group input {
        font-size: 15px;
    }
...
<script src="{{url('assets/js/fileinput/fileinput.js')}}"></script>
<script src="{{url('assets/js/fileinput/vi.js')}}"></script>
<script src="{{url('assets/toast/toastr.min.js')}}"></script>
    ...
    function initialize() {
        ...
        function handleNoGeolocation(errorFlag) {
            ...
            var options = {
                map: map,
                zoom: 19,
                position: new google.maps.LatLng(18.661380, 105.697430),
                content: content
            };
...
<script type="text/javascript" src="{{url('assets/js/selectize.js')}}"></script>
<script>
    $(function() {
        $('select').selectize();
    });
